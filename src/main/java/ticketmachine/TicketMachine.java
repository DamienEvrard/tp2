...
public class TicketMachine {
	...
	public void insertMoney(int amount) {
            if(amount<0){
                throw new IllegalArgumentException("la somme insere doit etre positive");
            }
            else{
	 ...
	 */
	public int refund() {
                int valBal=getBalance();
		System.out.println("Je vous rends : " + valBal + " centimes");
                balance=0;
		return valBal;
	}
	...
	public boolean printTicket() {
		// Simulate the printing of a ticket.
                if(this.price<=this.balance){
                    ...
                    System.out.println("Montant insifisant pour lancer l'impression");
                    return false;
                }
	}
}
